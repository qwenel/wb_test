...
async def get_feedback_id(fb_id:int, db=path) -> int | bool:
...
async def fill_unanswered_feedbacks(fb_id: int, fb_rating:str, fb_shop_wb:str, fb_product_wb:str, fb_text:str, api_key:str, db=path) -> bool:
